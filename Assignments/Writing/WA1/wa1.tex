...
\vspace{1mm}
\noindent 
{\textbf{Topics}: Intro, Bandits, MDP, Q-learning, SARSA, FA, DQN \hfill \textbf{Deadline}: 21/03/2024, 23:55}\\
...
\begin{figure}[!htp]
\includegraphics[width=0.35\textwidth]{gridworld.png}\centering
\end{figure}
...
\begin{figure}[!htp]
\includegraphics[width=0.25\textwidth]{cliff_walking.png}\centering
\end{figure}
...
\begin{figure}[!htp]
\centering \includegraphics[width=.3\textwidth]{symmetry_world.png}
\end{figure}
...
\begin{figure}[!htp]
\includegraphics[width=0.4\textwidth]{MDP_Q10.png}\centering
\end{figure}
\begin{enumerate}[label=(\alph*)]
